...
func (x *greetServiceSayHelloClientStreamingClient) Send(m *HelloRquest) error {
...
func (x *greetServiceSayHelloBiDirectionalClient) Send(m *HelloRquest) error {
	return x.ClientStream.SendMsg(m)
}
...
func (x *greetServiceSayHelloClientStreamingServer) Recv() (*HelloRquest, error) {
	m := new(HelloRquest)
...
func (x *greetServiceSayHelloBiDirectionalServer) Recv() (*HelloRquest, error) {
	m := new(HelloRquest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
